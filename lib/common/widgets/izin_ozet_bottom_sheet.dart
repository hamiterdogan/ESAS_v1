...
/// İzin talep özeti için ortak bottom sheet widget'ı
/// İzin Detayları sayfasındaki formata uygun olarak tasarlandı
class IzinOzetBottomSheet extends ConsumerStatefulWidget {
  final IzinIstekEkleReq request;
  final String izinTipi;
  final List<IzinOzetItem> ozetItems;
  final Future<void> Function() onGonder;
  final VoidCallback onSuccess;
  final void Function(String error) onError;

  const IzinOzetBottomSheet({
    super.key,
  ...
  @override
  ConsumerState<IzinOzetBottomSheet> createState() =>
      _IzinOzetBottomSheetState();
}

class _IzinOzetBottomSheetState extends ConsumerState<IzinOzetBottomSheet> {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Text(
              '${widget.izinTipi} İzin Talebini Gönder',
...
/// İzin özet bottom sheet'i göstermek için yardımcı fonksiyon
Future<void> showIzinOzetBottomSheet({
  required BuildContext context,
  required IzinIstekEkleReq request,
  required String izinTipi,
  required List<IzinOzetItem> ozetItems,
