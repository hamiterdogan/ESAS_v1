...
const int _teknikDestekHizmetTuru = 2;
const int _bilgiTeknolojiHizmetTuru = 1;
...
final bilgiTeknolojiDevamEdenTaleplerProvider =
    FutureProvider.autoDispose<TalepYonetimResponse>((ref) async {
      final repo = ref.watch(bilgiTeknolojileriIstekRepositoryProvider);
      final result = await repo.teknikDestekTaleplerimiGetir(
        tip: 0,
        hizmetTuru: _bilgiTeknolojiHizmetTuru,
      );
...
final bilgiTeknolojiTamamlananTaleplerProvider =
    FutureProvider.autoDispose<TalepYonetimResponse>((ref) async {
      final repo = ref.watch(bilgiTeknolojileriIstekRepositoryProvider);
      final result = await repo.teknikDestekTaleplerimiGetir(
        tip: 1,
