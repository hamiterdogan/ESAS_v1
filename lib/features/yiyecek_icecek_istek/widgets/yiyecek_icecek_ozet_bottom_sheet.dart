...
/// Özet satırı için model (Reuse existing structure or define new if needed)
class YiyecekIcecekOzetItem {
  final String label;
  final String value;
  final bool multiLine;

  const YiyecekIcecekOzetItem({
    required this.label,
    required this.value,
    this.multiLine = true,
  });
...
/// Yiyecek İçecek talep özeti için bottom sheet
class YiyecekIcecekOzetBottomSheet extends ConsumerStatefulWidget {
  final YiyecekIstekEkleReq request;
  final String talepTipi;
  final List<YiyecekIcecekOzetItem> ozetItems;
  final Future<void> Function() onGonder;
  final VoidCallback onSuccess;
  final void Function(String error) onError;
  final Map<String, dynamic>? customJsonSnapshot;

  const YiyecekIcecekOzetBottomSheet({
    super.key,
  ...
  @override
  ConsumerState<YiyecekIcecekOzetBottomSheet> createState() =>
      _YiyecekIcecekOzetBottomSheetState();
}

class _YiyecekIcecekOzetBottomSheetState
    extends ConsumerState<YiyecekIcecekOzetBottomSheet> {
...
Future<void> showYiyecekIcecekOzetBottomSheet({
  required BuildContext context,
  required YiyecekIstekEkleReq request,
  required String talepTipi,
  required List<YiyecekIcecekOzetItem> ozetItems,
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (sheetContext) {
      return YiyecekIcecekOzetBottomSheet(
        request: request,
        talepTipi: talepTipi,
        ozetItems: ozetItems,
        onGonder: onGonder,
