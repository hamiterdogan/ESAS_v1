...
///
/// Bu sınıf, öğrenci seçim sheet'inin state'ini yönetir ve
/// ana ekranla iletişimi sağlar.
class OgrenciFilterState {
  OgrenciFilterState({
...
class OgrenciFilterSummaryHelper {
  const OgrenciFilterSummaryHelper._();
...
/// Öğrenci filter sheet ana menüsü.
class OgrenciFilterMainMenu extends StatelessWidget {
  const OgrenciFilterMainMenu({
    super.key,
    required this.state,
  ...
  final OgrenciFilterState state;
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        FilterMainMenuItem(
          title: 'Okul',
          selectedValue: OgrenciFilterSummaryHelper.summaryForOkul(
        ...
        FilterMainMenuItem(
          title: 'Seviye',
          selectedValue: OgrenciFilterSummaryHelper.summaryForSeviye(
        ...
        FilterMainMenuItem(
          title: 'Sınıf',
          selectedValue: OgrenciFilterSummaryHelper.summaryForSinif(
            state.selectedSinif,
          ),
        ...
        FilterMainMenuItem(
          title: 'Kulüp',
          selectedValue: OgrenciFilterSummaryHelper.summaryForKulup(
            state.selectedKulup,
          ),
        ...
        FilterMainMenuItem(
          title: 'Takım',
          selectedValue: OgrenciFilterSummaryHelper.summaryForTakim(
            state.selectedTakim,
          ),
        ...
        FilterMainMenuItem(
          title: 'Öğrenci',
          selectedValue: OgrenciFilterSummaryHelper.summaryForOgrenci(
...
/// Öğrenci seçim filter page.
class OgrenciListFilterPage extends StatefulWidget {
  const OgrenciListFilterPage({
    super.key,
  ...
  @override
  State<OgrenciListFilterPage> createState() => _OgrenciListFilterPageState();
}

class _OgrenciListFilterPageState extends State<OgrenciListFilterPage> {
