...
class TemizlikMalzemesiIstekScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TemizlikMalzemesiIstekScreen> createState() =>
      _TemizlikMalzemesiIstekScreenState();
}

class _TemizlikMalzemesiIstekScreenState
    extends ConsumerState<TemizlikMalzemesiIstekScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    final sarfReq = SarfMalzemeEkleReq(
      ...
      talepTuru: 'Temizlik Malzemeleri',
