...
class PromosyonMalzemesiIstekScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PromosyonMalzemesiIstekScreen> createState() =>
      _PromosyonMalzemesiIstekScreenState();
}

class _PromosyonMalzemesiIstekScreenState
    extends ConsumerState<PromosyonMalzemesiIstekScreen> {
  ...
  Future<void> _scrollToWidget(GlobalKey key) async {
    ...
    final sarfReq = SarfMalzemeEkleReq(
      ...
      talepTuru: 'Promosyon Malzemeleri',
