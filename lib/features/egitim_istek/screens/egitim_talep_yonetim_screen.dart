...
class _EgitimTalepYonetimScreenState
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          controller: _tabController,
          children: [
            _buildPlaceholderList('Henüz devam eden eğitim talebi bulunmuyor.'),
            _buildPlaceholderList('Tamamlanan eğitim talebi bulunmuyor.'),
          ],
        ),
  ...
  Widget _buildPlaceholderList(String message) {
    return Container(color: const Color(0xFFEEF1F5));
  }
}
